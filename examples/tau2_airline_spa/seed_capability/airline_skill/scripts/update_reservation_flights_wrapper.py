...
def update_reservation_flights_wrapper(
    ...
    Args:
        ...
        cabin (str): The cabin class of the reservation, one of 'basic_economy',
            'economy', 'business'.
        flights (str): An array of objects containing details about each piece of flight
            in the ENTIRE new reservation. Even if a flight segment is not
            changed, it should still be included in the array.
        payment_id (str): The payment id stored in user profile, such as
