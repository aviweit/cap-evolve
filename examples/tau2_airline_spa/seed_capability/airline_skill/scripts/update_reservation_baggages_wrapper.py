...
def update_reservation_baggages_wrapper(
    ...
    Args:
        ...
        total_baggages (int): The updated total number of baggage items included in the
            reservation.
        nonfree_baggages (int): The updated number of non-free baggage items included in
            the reservation.
